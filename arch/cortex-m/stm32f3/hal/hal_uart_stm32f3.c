...
#define UART_COUNT (UART_COUNT_1 + UART_COUNT_2 + UART_COUNT_3)
...
#ifdef CONFIG_UART_STM32_RX_INTERRUPT
void uart_irq_rxchar_stm32f3(unsigned int hdl, char x);
__attribute__((weak)) void uart_irq_rxchar_stm32f3(unsigned int hdl, char x) {}

static void stm32f3_uart_irq(int phy_hdl_ix) {
...
#if defined(USART1)
void USART1_IRQHandler(void) { stm32f3_uart_irq(PHYIX_U1); }
#endif
#if defined(USART2)
void USART2_IRQHandler(void) { stm32f3_uart_irq(PHYIX_U2); }
#endif
#if defined(USART3)
void USART3_IRQHandler(void) { stm32f3_uart_irq(PHYIX_U3); }
#endif
#endif
