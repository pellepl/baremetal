...
static void list_paint(ui_component_t *ui, void *ctx, ui_info_t *i) {
    ...
    switch (ui->state & UI_STATE_ALIGNV__MASK) {
        case UI_STATE_ALIGNV_CENTER: ty = y+ih/2; alignv = DISP_STR_ALIGN_CENTER; break;
        case UI_STATE_ALIGNV_BOTTOM: ty = y+ih; alignv = DISP_STR_ALIGN_RIGHT_BOTTOM; break;
        default: ty = y; alignv = DISP_STR_ALIGN_LEFT_TOP; break;
    }
