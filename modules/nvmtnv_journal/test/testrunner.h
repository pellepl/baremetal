...
#define TEST_CHECK_EQ(x, y)                                                        \
	...
	{                                                                              \
		intptr_t _x = (intptr_t)(x);                                               \
		intptr_t _y = (intptr_t)(y);                                               \
		if (_x != _y)                                                              \
		{                                                                          \
			printf("  TEST FAIL %s:%d, %ld != %ld\n", __FILE__, __LINE__, _x, _y); \
			goto __fail_stop;                                                      \
		}                                                                          \
	} while (0);
...
#define TEST(tf)                             \
	static int __test_##tf(struct test_s *t) \
	{                                        \
		do
