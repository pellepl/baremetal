...
static void tick_timer_set_period(tick_timer_t *t, uint32_t ticks)
{
    tick_timer_hal_set_period(t, ticks);
    t->timer_period = ticks;
}

static void tick_timer_decide_next_period(tick_timer_t *t)
{
...
static void tick_timer_await_splice(tick_timer_t *t)
{
